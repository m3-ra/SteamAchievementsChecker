...
class RoomGameInfoRepositoryTest {
    ...
    fun `SHOULD convert to game info WHEN fetching db data`() =
        runTest {
            // Arrange
            val game1 = GameInfoDbEntity(1, "Game 1", 50.0, 10, 20, false)
            val game2 = GameInfoDbEntity(2, "Game 2", 75.0, 15, 20, false)
            ...
            // Assert
            val expected = listOf(
                GameInfo(1, "Game 1", AchievementsResult.HasAchievements(50.0, 10, 20)),
                GameInfo(2, "Game 2", AchievementsResult.HasAchievements(75.0, 15, 20))
            )
    ...
    fun `SHOULD convert to db entity WHEN saving game info`() =
        runTest {
            ...
            val games = listOf(GameInfo(1, "Game 1", AchievementsResult.HasAchievements(50.0, 10, 20)))
            ...
            // Assert
            coVerify {
                gameInfoDao.insertAll(listOf(GameInfoDbEntity(1, "Game 1", 50.0, 10, 20, false)))
            }
        }
}
