...
class SortGameInfoUseCaseTest {
    ...
    fun `SHOULD sort games WHEN use case is called`() {
        ...
        val games = listOf(
            ...
            GameInfo(4, "The Game", AchievementsResult.HasAchievements(25.0, 5, 20)),
            GameInfo(5, "Lll Game", AchievementsResult.HasAchievements(25.0, 5, 20))
        )
        ...
        val expected = listOf(
            ...
            GameInfoItem(4, "The Game", AchievementsResult.HasAchievements(25.0, 5, 20), "Game", "TG"),
            GameInfoItem(5, "Lll Game", AchievementsResult.HasAchievements(25.0, 5, 20), "Lll Game", "LG")
        )
    ...
    fun `SHOULD sort games ignoring case WHEN they have capital letters`() {
        // Arrange
        val games = listOf(
            GameInfo(1, "TU", AchievementsResult.HasAchievements(100.0, 20, 20)),
            GameInfo(2, "Ti", AchievementsResult.HasAchievements(100.0, 20, 20)),
            GameInfo(3, "Ta", AchievementsResult.HasAchievements(100.0, 20, 20)),
            GameInfo(4, "TH", AchievementsResult.HasAchievements(100.0, 20, 20))
        )
        ...
        // Assert
        val expected = listOf(
            GameInfoItem(3, "Ta", AchievementsResult.HasAchievements(100.0, 20, 20), "Ta", "Ta"),
            GameInfoItem(4, "TH", AchievementsResult.HasAchievements(100.0, 20, 20), "TH", "TH"),
            GameInfoItem(2, "Ti", AchievementsResult.HasAchievements(100.0, 20, 20), "Ti", "Ti"),
            GameInfoItem(1, "TU", AchievementsResult.HasAchievements(100.0, 20, 20), "TU", "TU")
        )
        assertEquals(expected, result)
    }
    ...
    fun `SHOULD sort games with mixed achievements WHEN some have no achievements`() {
        ...
        val games = listOf(
            ...
            GameInfo(5, "The Game", AchievementsResult.HasAchievements(25.0, 5, 20))
        )
        ...
        val expected = listOf(
            ...
            GameInfoItem(1, "Game xyz", AchievementsResult.HasAchievements(50.0, 10, 20), "Game xyz", "Gx"),
            GameInfoItem(5, "The Game", AchievementsResult.HasAchievements(25.0, 5, 20), "Game", "TG"),
